...
Identical to scripts/run_arm.py except stage 1 is `planner.cmbc._diag_l5_takt`
...
STAGES = ["_diag_l5_takt", "l6_build_gate", "l7_pull_release",
...
def main() -> int:
    ...
    for st in STAGES:
        flag = "--out" if st.endswith("l5_takt") else "--run"
